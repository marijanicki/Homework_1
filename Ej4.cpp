...
bool compare(string word1, string word2, int idx){
...
int main(){
    ...
    string word1 = "Las olas del mar rompen suavemente en la orilla mientras la brisa acaricia la piel";
    string word2 = "El sol se oculta lentamente detrás de las montañas, pintando el cielo con tonos anaranjados.";
